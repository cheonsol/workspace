...
import com.kh.textGame.service.UserDetailsServiceImpl;
...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity // 이 어노테이션 추가
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers("/api/auth/**", "/api/boards", "/api/boards/**").permitAll() // 인증 관련, 게시판 조회 API는 모두 허용
